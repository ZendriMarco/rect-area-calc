...
function App() {
  const widthId = reactExports.useId();
  const heightId = reactExports.useId();
  const [width, setWidth] = reactExports.useState("");
  const [height, setHeight] = reactExports.useState("");
  const [widthTouched, setWidthTouched] = reactExports.useState(false);
  const [heightTouched, setHeightTouched] = reactExports.useState(false);
  const [area, setArea] = reactExports.useState(null);
  const [resultKey, setResultKey] = reactExports.useState(0);
  ...
  const isValid = !Number.isNaN(widthVal) && widthVal > 0 && !Number.isNaN(heightVal) && heightVal > 0;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "bg-card border-b border-border shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 h-14 flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-foreground text-base tracking-tight", children: "RectCalc" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-border select-none", children: "|" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm font-body", children: "Calculator" })
      ] }),
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground tracking-tight leading-tight", children: "Rectangle Area Calculator" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-sm text-muted-foreground font-body", children: "Enter the width and height of the rectangle below." })
              ] }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      ...
                      className: [
                        ...
                        widthError ? "border-destructive focus-visible:ring-destructive" : ""
                      ].join(" "),
                      "aria-describedby": widthError ? `${widthId}-error` : void 0,
                      "aria-invalid": !!widthError
                    }
                  ),
                  widthError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      id: `${widthId}-error`,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Input,
                    {
                      ...
                      "aria-describedby": heightError ? `${heightId}-error` : void 0,
                      "aria-invalid": !!heightError
                    }
                  ),
                  heightError && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      id: `${heightId}-error`,
              ...
              area !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs uppercase tracking-widest text-muted-foreground font-body mb-1", children: "Total Area" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-display font-bold text-3xl text-foreground leading-tight", children: [
                      area % 1 === 0 ? area.toFixed(0) : area.toFixed(2),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl ml-1 align-super font-mono", children: "cm²" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 text-xs text-muted-foreground font-body", children: [
                      widthVal,
                      " cm × ",
                      heightVal,
                      " cm"
              ...
              area === null && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body", children: "Result will appear here after calculation" })
                }
              )
            ]
          }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-6 h-12 flex items-center justify-between text-xs text-muted-foreground font-body", children: [
